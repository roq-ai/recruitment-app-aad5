...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'developer.create': {
    roles: ['employer', 'recruiter', 'hr-manager'],
    key: 'new-developer-registered',
    tenantPath: ['employer', 'interview', 'developer'],
    userPath: [],
  },
  'interview.create': {
    roles: ['employer', 'recruiter', 'hr-manager'],
    key: 'interview-scheduled',
    tenantPath: ['employer', 'interview'],
    userPath: [],
  },
  'interview.update': {
    roles: ['employer', 'recruiter', 'hr-manager'],
...
const ownerRoles: string[] = ['employer'];
const customerRoles: string[] = [];
const tenantRoles: string[] = ['employer', 'recruiter', 'hr-manager'];
