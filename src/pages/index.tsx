  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Streamline Your Hiring Process with Recruitment App - Your One-Stop Solution for Finding, Interviewing, and Hiring Top Software Developers with Ease and Efficiency."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Streamline Your Hiring Process with Recruitment App - Your One-Stop Solution for Finding, Interviewing, and Hiring Top Software Developers with Ease and Efficiency.`}
            </Text>
            <Box
            ...
            >
              <Stack direction={{ md: 'row', base: 'column' }} spacing="1.5rem">
                <Card userTypeName="Employer" type="employer" abilities={appConfig.ownerAbilities} />
              </Stack>
            </Box>
          </Box>
          <Box pt={4}>
